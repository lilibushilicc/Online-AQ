...
> 2026-06-22 更新：修复 Android 端页面视觉割裂—统一所有卡片圆角14dp、背景色，移除 panel_brand/panel_info 等不一致色值，统一描边与阴影
> 2026-06-22 更新：Android 学生端全局主题切换—Slate & Teal Executive 暗色玻璃拟态风格，登录页重设计、底部导航、渐变背景、整体视觉统一
> 2026-06-22 更新：学生考试列表页重设计—玻璃拟态统计卡片、2列考试卡片网格、搜索栏、状态徽章
> 2026-06-22 更新：登录页全面重设计—左右分栏品牌布局、动态粒子背景、玻璃拟态登录卡片
> 2026-06-19 更新：学生端考试页面优化—题型分组、导航栏分类、对/错按钮、试卷结构预览、导出带大题头、草稿恢复提示
> 2026-06-18 更新：题库导入改爲「解析预览—全选/勾选—一键上传」流程；试卷管理选题面板支持全选
> 2026-06-16 更新：修复 Canvas 暗色模式白屏问题
