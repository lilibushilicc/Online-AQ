...
import com.example.olineaqspring.exception.ResourceNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ApiResponse<Void> handleMessageNotReadable(HttpMessageNotReadableException exception) {
        ...
        return ApiResponse.fail("请求参数格式错误，请检查端口号等字段是否为有效数字");
    }
    ...
    public ApiResponse<Void> handleRuntimeException(RuntimeException exception) {
        ...
        return ApiResponse.fail(exception.getMessage() != null ? exception.getMessage() : "系统繁忙，请稍后重试");
    }
}
