...
public class BeanUtils {
    ...
    public static void copyQuestion(QuestionRequest source, Question target) {
        if (source.getQuestionContent() != null) target.setQuestionContent(source.getQuestionContent());
        if (source.getQuestionType() != null) target.setQuestionType(source.getQuestionType());
        ...
        if (source.getCorrectAnswer() != null) target.setCorrectAnswer(source.getCorrectAnswer());
        if (source.getScore() != null) target.setScore(source.getScore());
