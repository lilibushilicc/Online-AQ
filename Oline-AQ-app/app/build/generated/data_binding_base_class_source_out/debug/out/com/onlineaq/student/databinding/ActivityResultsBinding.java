...
public final class ActivityResultsBinding implements ViewBinding {
  ...
  private ActivityResultsBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvResults,
  ...
  public static ActivityResultsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityResultsBinding((LinearLayout) rootView, rvResults, swipeRefresh, toolbar,
          tvEmpty);
    }
